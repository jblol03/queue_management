...
from account.models import User, EndUser
...
class EndUserSerializer(serializers.ModelSerializer):
    password = serializers.CharField(write_only=True, required=False)  # Password won't be needed for OTP-based authentication
